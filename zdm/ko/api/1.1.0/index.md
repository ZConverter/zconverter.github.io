...
- **GET /backups/histories** — 백업 히스토리 목록 조회 (`partition` 필터 추가)
- **GET /backups/histories/:identifier** — 백업 히스토리 단건 조회 (`partition` 필터 추가)
- **GET /recoveries/histories** — 복구 히스토리 목록 조회 (`serverType`, `partition` 필터 추가)
- **GET /recoveries/histories/:identifier** — 복구 히스토리 단건 조회 (`serverType`, `partition` 필터 추가)
