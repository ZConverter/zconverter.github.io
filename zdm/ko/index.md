...
| {{ ver.version }} | {{ ver.status }} | [바로가기](/zdm/ko/cli/{{ ver.version }}/index) | [Windows](/downloads/zdm-cli/{{ ver.version }}/zdm-cli-windows.zip) · [Linux](/downloads/zdm-cli/{{ ver.version }}/zdm-cli-linux.tar.gz) |
{% endfor %}
...
| 항목 | 내용 |
|------|------|
| 문서 | [ZDM-API 문서 바로가기](/zdm/ko/api/1.0.3/index) |
...
| {{ ver.version }} | {{ ver.status }} | [바로가기](/zdm/ko/api/{{ ver.version }}/index) | [Linux](/downloads/zdm-api/{{ ver.version }}/zdm-api-linux.tar.gz) |
{% endfor %}
