...
특정 사용자 정보를 조회합니다.**Path Parameters:**
...
사용자 정보를 업데이트합니다.**Path Parameters:**
...
특정 서버 정보를 조회합니다.**Path Parameters:**
...
특정 서버의 파티션 정보를 조회합니다.**Path Parameters:**
...
특정 스케줄 정보를 조회합니다.**Path Parameters:**
...
특정 백업 작업 정보를 조회합니다.**Path Parameters:**
