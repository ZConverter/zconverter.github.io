  ...
  - title: "CLI Documentation"
    links:
      ...
      - title: "Schedule Management"
        ...
        sublinks:
          - title: "스케줄 조회"
            url: "/zdm/cli/docs_kr/schedules#schedule-list"
          - title: "스케줄 등록"
            url: "/zdm/cli/docs_kr/schedules#schedule-regist"
          - title: "스케줄 생성"
            url: "/zdm/cli/docs_kr/schedules#schedule-create"
          - title: "스케줄 검증"
            url: "/zdm/cli/docs_kr/schedules#schedule-verify"
