...
# 이메일과 비밀번호를 직접 지정하여 토큰 발급
zdm-cli token issue --user-mail admin@example.com -p mypassword

# JSON 형식으로 출력
zdm-cli token issue -p mypassword --output json

# 별칭 사용
zdm-cli token i -p mypassword
```
